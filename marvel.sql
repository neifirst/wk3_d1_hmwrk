...
SELECT name FROM people WHERE name = 'Elanor McCulloch';

DELETE FROM movies WHERE title = 'Batman Begins';

SELECT * FROM movies;

INSERT INTO people (name) VALUES ('Stevie Meiklejohn');
...
DELETE FROM movies WHERE title = 'The Incredible Hulk' OR title = 'Iron Man';
